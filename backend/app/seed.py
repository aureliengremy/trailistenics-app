...
WEEKS = [
    ...
    (5, "30 juin", "base", "1h30 · ~14 km · 400 m D+", 90, 400, 14,
     4, None, "Côtes : 8×1 min vif (RPE 8/10), récup : redescente en trot — 3 dernières descentes appuyées (RPE 6/10)",
    ...
    (12, "18 août", "affutage", "1h15 · ~12 km · 350 m D+", 75, 350, 12,
     3, None, "Côtes : 5×1 min vif (RPE 8/10), récup : redescente en trot",
    ...
    (13, "25 août", "affutage", "45 min relâché + lignes → COURSE", 45, 120, None,
     2, None, "Repos, ou 20 min de footing très facile (RPE 3/10)",
